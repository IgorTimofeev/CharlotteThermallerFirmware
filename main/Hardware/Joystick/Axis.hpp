...
namespace pizda {
	...
	class ButtonAxis : public Axis {
		public:
			...
			void check(bool& positivePressed, bool& negativePressed, bool& razyob);
		...
		private:
			...
			constexpr static uint32_t _multiDelayUs = 600'000;
			constexpr static uint32_t _multiIntervalUs = 100'000;
			constexpr static uint32_t _multiRazyobDelayUs = 1'500'000;

			int64_t _multiNextTimeUs = 0;
			int64_t _multiRazyobTimeUs = 0;
	};
}